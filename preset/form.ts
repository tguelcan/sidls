export default {
  ...
  "input[type='radio'], input[type='checkbox']": {
    "@apply h-4 w-4 border-primary text-primary focus:ring-0 focus:ring-offset-0":
      {},
  },
  "input[type='checkbox']": {
    "@apply rounded": {},
  ...
  // Checklist
  ".check-list": {
    "@apply grid grid-cols-[24px_1fr_auto] items-center gap-6 rounded-lg p-4 ring-2 ring-transparent hover:bg-light has-[:checked]:bg-light has-[:checked]:text-primary":
      {},
  },
};
